...
def press(event):
    ...
    line3 = ax.plot(b3, b1/b2, color="yellow", label="0_3")
    line5 = ax.plot(c3, c1/c2, color="green", label="1_2")
...
b1, b2, b3 = dataset(dirPath+"test_0_3.txt")
c1, c2, c3 = dataset(dirPath+"test_1_2.txt")
d1, d2, d3 = dataset(dirPath+"test_1_3.txt")
e1, e2, e3 = dataset(dirPath+"test_2_3.txt")
move = 0
fig, ax = plt.subplots(1, figsize=(8, 6))
